...
-- Berechtigung für Benutzer Kunde_Manager: 
GRANT EXECUTE ON PROCEDURE Techelectronics.getCustomerInfo TO 'kunde_manager'@'localhost';

-- Berechtigung für Benutzer lager_manager: 
GRANT EXECUTE ON PROCEDURE Techelectronics.updateStock TO 'lager_manager'@'localhost';

-- Berechtigung für Benutzer admin_user: 
GRANT EXECUTE ON PROCEDURE Techelectronics.createOrder TO 'admin_user'@'localhost';
